...
- Defense pact + forward basing: high \(\pi,d\); moderate \(q_U\) reduction; \(s\) neutral.
...
\[
q^\*(t) \equiv \mathbb{E}[q \mid t] = (1-\pi(t))\,q_U(t) + \pi(t)\,q_I(t) = q_U(t) - \pi(t)\,d(t).
\]
...
Equivalently, **no attack (deterrence)** occurs iff
\[
\boxed{\;\pi(t) \;\ge\; \frac{q_U(t) - \hat q(t)}{d(t)}\;}\quad\text{(Deterrence condition)}.
\]
...
|---|---:|---:|---:|---:|---|
| None | ~0 | 0 | \(q_0\) | \(s_0\) | No promise, no help |
...
## 10) Useful extensions (drop‑in modules)
...
## (Optional Appendix) Endogenous domestic policy: repression & concessions

Let
\[
q_U(t,r,y)=q_U^0(t)-\phi_r(t)\,r-\phi_y(t)\,y,\quad
...
\[
D(r,y;t)=\big(q_U^0(t)-\pi(t)d(t)\big)-\frac{s^0(t)-\ell_R+k_R}{\Delta_R}-A_r r-A_y y.
\]
...
\[
\min_{r,y\ge 0}\ \tfrac12(c_r r^2+c_y y^2)\ \ \text{s.t.}\ \ A_r r + A_y y \ge D_0,
\]
with solution
\[
r^\*=\lambda \frac{A_r}{c_r},\quad y^\*=\lambda \frac{A_y}{c_y},\quad
